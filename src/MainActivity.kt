...
fun main(){
        ...
        */
        ...
        while (saldo >= cantidad_inversion){
            ...
            if (empresa != null){
                ...
                print ("\nSe ha invertido $cantidad_inversion ${moneda} en $empresa")
    ...
    fun mostrar_saldo(cantidad: Float){
        ...
        print("\n\nTienes $cantidad ${moneda}")
    }

    fun ingresar_dinero(cantidad: Float){
        saldo += cantidad
        print("\nSe han ingresado $cantidad ${moneda}")
        mostrar_saldo (saldo)
    }
    fun ingresar_sueldo(){
        saldo += sueldo
        print("\nSe han ingresado tu sueldo de $sueldo ${moneda}")
        mostrar_saldo (saldo)
    }
    fun retirar_dinero(cantidad: Float){
        saldo -= cantidad
        print("\nSe han retirado $cantidad ${moneda}")
        mostrar_saldo (saldo)
    }
